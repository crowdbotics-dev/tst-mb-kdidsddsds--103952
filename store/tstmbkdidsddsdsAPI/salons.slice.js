...
export const api_v1_salon_list = createAsyncThunk("salons/api_v1_salon_list", async payload => {
  const response = await apiService.api_v1_salon_list(payload);
  return response.data;
});
export const api_v1_salon_create = createAsyncThunk("salons/api_v1_salon_create", async payload => {
  const response = await apiService.api_v1_salon_create(payload);
  return response.data;
});
export const api_v1_salon_retrieve = createAsyncThunk("salons/api_v1_salon_retrieve", async payload => {
  const response = await apiService.api_v1_salon_retrieve(payload);
  return response.data;
});
export const api_v1_salon_update = createAsyncThunk("salons/api_v1_salon_update", async payload => {
  const response = await apiService.api_v1_salon_update(payload);
  return response.data;
});
export const api_v1_salon_partial_update = createAsyncThunk("salons/api_v1_salon_partial_update", async payload => {
  const response = await apiService.api_v1_salon_partial_update(payload);
  return response.data;
});
export const api_v1_salon_destroy = createAsyncThunk("salons/api_v1_salon_destroy", async payload => {
...
const salonsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_salon_list.pending, (state, action) => {
