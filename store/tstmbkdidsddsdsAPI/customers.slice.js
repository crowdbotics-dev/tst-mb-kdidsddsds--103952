...
export const api_v1_customer_list = createAsyncThunk("customers/api_v1_customer_list", async payload => {
  const response = await apiService.api_v1_customer_list(payload);
  return response.data;
});
export const api_v1_customer_create = createAsyncThunk("customers/api_v1_customer_create", async payload => {
  const response = await apiService.api_v1_customer_create(payload);
  return response.data;
});
export const api_v1_customer_retrieve = createAsyncThunk("customers/api_v1_customer_retrieve", async payload => {
  const response = await apiService.api_v1_customer_retrieve(payload);
  return response.data;
});
export const api_v1_customer_update = createAsyncThunk("customers/api_v1_customer_update", async payload => {
  const response = await apiService.api_v1_customer_update(payload);
  return response.data;
});
export const api_v1_customer_partial_update = createAsyncThunk("customers/api_v1_customer_partial_update", async payload => {
  const response = await apiService.api_v1_customer_partial_update(payload);
  return response.data;
});
export const api_v1_customer_destroy = createAsyncThunk("customers/api_v1_customer_destroy", async payload => {
...
const customersSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_customer_list.pending, (state, action) => {
